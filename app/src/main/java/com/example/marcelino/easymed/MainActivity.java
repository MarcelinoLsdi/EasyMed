...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnBuscarMed = findViewById(R.id.button);
        ...
        btnBuscarMed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String med = nome.getText().toString();
                if (med != null && !med.equals("")) {

                    call = new RetrofitConfig()
                            .getMedicamento()
                            .buscarMedicamento(med);
                    try {
                        call.enqueue(new Callback<Capability>() {
                            @Override
                            public void onResponse(Call<Capability> call, Response<Capability> response) {
                                capability = response.body();

                                if (capability != null) {
                                    result.setText(capability.getId() + " : " + capability.getName());
                                } else {
                                    result.setText("Medicamento não encontrado");
                                }
                            }

                            @Override
                            public void onFailure(Call<Capability> call, Throwable t) {
                    ...
                    Log.d("MedicamentoService","Digite o Medicamento");
                }
            }
        });
    }
